...
export default hopeTheme({
  ...
  // hostname: "https://mengyahui.github.io",
  ...
  // iconAssets: "iconfont",
  iconAssets: "//at.alicdn.com/t/c/font_4149168_ic3m1e9zmxf.css",
  ...
  sidebarIcon: false,
  /**
   * 结构侧边栏排序器,默认值：["readme", "order", "title", "filename"]
